      ...
      <Link href={`/token/${token.mint}`} className="block h-full">
        ...
        >
          ...
          <div className="mb-2 grid grid-cols-3 gap-1.5 sm:mb-3.5 sm:gap-2.5">
            <div className="rounded-[10px] border border-white/8 bg-white/[0.04] p-1.5 sm:rounded-2xl sm:p-3" style={{ filter: "drop-shadow(0 0 6px rgba(255,255,255,0.22))" }}>
            ...
            <div className="rounded-[10px] border border-white/8 bg-[#00ff88]/[0.05] p-1.5 sm:rounded-2xl sm:p-3" style={{ filter: "drop-shadow(0 0 6px rgba(255,255,255,0.22))" }}>
