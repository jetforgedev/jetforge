      ...
      <Link href={`/token/${token.mint}`} className="block h-full">
        ...
        >
          ...
          <div className="mb-2 grid grid-cols-3 gap-1.5 sm:mb-3.5 sm:gap-2.5">
            <div className="rounded-[10px] border border-white/20 bg-white/[0.07] p-1.5 sm:rounded-2xl sm:p-3" style={{ boxShadow: "0 0 24px rgba(255,255,255,0.18)" }}>
            ...
            <div className="rounded-[10px] border border-[#00ff88]/40 bg-[#00ff88]/[0.09] p-1.5 sm:rounded-2xl sm:p-3" style={{ boxShadow: "0 0 24px rgba(0,255,136,0.30)" }}>
