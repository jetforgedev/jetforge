    ...
    (
      ...
      >
        <svg width="30" height="30" viewBox="0 0 96 96" fill="none">
          <defs>
            <linearGradient id="iconRing" x1="14" y1="84" x2="83" y2="12" gradientUnits="userSpaceOnUse">
              <stop stopColor="#35ff86" />
              <stop offset="1" stopColor="#00e5ff" />
            </linearGradient>
            <linearGradient id="iconLeaf" x1="24" y1="70" x2="69" y2="17" gradientUnits="userSpaceOnUse">
              <stop stopColor="#1dd7d0" />
              <stop offset="0.55" stopColor="#35ff86" />
              <stop offset="1" stopColor="#19ff43" />
            </linearGradient>
          </defs>
          <circle cx="48" cy="48" r="42" stroke="url(#iconRing)" strokeWidth="2.4" />
          <path
