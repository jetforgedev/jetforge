      ...
      {items.map((s, index) => (
        ...
        >
          <div className="mb-3 flex items-center justify-between">
            ...
            <span className="text-xs text-[#00ff88]">{index === 0 ? "Live" : index === 1 ? "Momentum" : "Flow"}</span>
          </div>
...
export default function HomePage() {
  ...
  return (
    <div className="flex gap-6">
      ...
      <Link
        href="/launch"
        className="fixed bottom-5 right-4 z-40 inline-flex items-center gap-2 rounded-full bg-[linear-gradient(90deg,#00ff88,#00e5ff)] px-5 py-3 text-sm font-extrabold text-[#03110d] shadow-[0_18px_40px_rgba(0,255,136,0.28)] transition-all hover:-translate-y-0.5 sm:right-6"
      >
