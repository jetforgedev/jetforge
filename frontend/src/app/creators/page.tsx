            ...
            >
              ...
              <div className="flex items-center gap-2 min-w-0 flex-1">
                {resolveImageUrl(creator.latestToken?.imageUrl) ? (
                  <img loading="lazy" decoding="async" src={resolveImageUrl(creator.latestToken?.imageUrl)!} alt="" width={36} height={36} className="w-9 h-9 rounded-lg object-cover shrink-0" />
                ) : (
                ...
                {creators.map((creator) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 min-w-0">
                      {resolveImageUrl(creator.latestToken?.imageUrl) ? (
                        <img loading="lazy" decoding="async" src={resolveImageUrl(creator.latestToken?.imageUrl)!} alt="" width={32} height={32} className="w-8 h-8 rounded-lg object-cover flex-shrink-0" />
                      ) : (
